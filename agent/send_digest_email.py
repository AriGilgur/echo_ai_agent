...
def format_html(df):
    ...
    <html>
      <body style="font-family: 'Segoe UI', sans-serif; background-color: #f4f6f8; padding: 30px;">
        <div style="max-width: 700px; margin: auto; background-color: #ffffff; border-radius: 10px; padding: 25px; box-shadow: 0 4px 10px rgba(0,0,0,0.05);">
          <h2 style="color: #2c3e50; text-align: center;">🫀 Weekly Digest: Echo-AI Research Highlights</h2>
          <p style="text-align: center; color: #555;">Curated summaries from PubMed and arXiv — powered by GPT-4o</p>
    ...
    for _, row in df.iterrows():
        ...
        <div style="border: 1px solid #e0e0e0; border-radius: 8px; padding: 15px 20px; margin: 20px 0; background-color: #fdfdfd;">
          ...
          <a href="{row['link']}" style="display: inline-block; margin-top: 8px; padding: 8px 12px; background-color: #007BFF; color: white; text-decoration: none; border-radius: 4px;">🔗 Read Full Article</a>
        </div>
        """
